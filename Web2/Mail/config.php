...
$org_logo_width  = '308';
$org_logo_height = '111';
$org_title     = "WoodyToys Mail Server";
$signout_page  = '';
$frame_top     = '_top';

$provider_uri     = 'http://intranet.berger.ephec-ti.be';

$provider_name     = 'WoodyToys Intranet';

$motd = "Bienvenue sur le système de messagerie de WoodyToys !";

$squirrelmail_default_language = 'fr_FR';
$default_charset       = 'iso-8859-1';
$lossy_encoding        = false;

$domain                 = 'berger.ephec-ti.be';
...
$data_dir                 = '/var/local/mail/data/';
$attachment_dir           = '/var/local/mail/attach/';
$dir_hash_level           = 0;
